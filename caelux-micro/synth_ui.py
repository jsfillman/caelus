...
class SynthUI(QWidget):
    def __init__(self, server=None):  # Add server parameter with default None
        super().__init__()
        self.setWindowTitle("Caelux Control")
        ...
        self.setMinimumWidth(1200)  # Increased width to accommodate new panel
    ...
    def make_oscillator_panel(self):
        ...
        self.wave_type.addItems(self.wave_bank.get_table_list())
        ...
        box.setLayout(vbox)
        return box# Increased width to accommodate the filter panel
